...
(function() {
  var $, aliveNeighbors, deadOrAlive, drawCell, drawGrid, drawLoop, initGraph, initGrid, mainPgm, neighborStatus, nextGeneration,
    _this = this;
  ...
  neighborStatus = function(x, y, a, b) {
    if ((x === a && y === b) || a < 0 || b < 0 || b >= window.grid.w || a >= window.grid.h) {
      return "dead";
    } else {
